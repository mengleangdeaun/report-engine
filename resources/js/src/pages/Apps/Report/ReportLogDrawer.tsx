...
import {
    ...
    IconHistory,
    IconEye,
    IconShare, IconCheck, IconQrcode, IconDeviceMobile, IconDeviceDesktop, IconDeviceTablet, IconMapPin, IconCopy, IconExternalLink
                                                                                ...
                                                                                <div className="mb-4">
                                                                                    <div className="flex gap-3">
                                                                                        ...
                                                                                        <button
                                                                                            onClick={handleShareAction}
                                                                                            disabled={isCopied}
                                                                                            className={`group relative overflow-hidden px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 active:scale-95 ${isCopied
                                                                        ...
                                                                        <div className="relative p-5">
                                                                            <div className="flex items-center justify-between">
                                                                                ...
                                                                                <div className="flex items-center gap-4">
                                                                                    ...
                                                                                    <div className="relative">
                                                                                        {/* Outer Glow Ring */}
                                                                                        <div className={`absolute -inset-2 rounded-full blur-md transition-all duration-500 ${isPublic
                                                                                                ? 'bg-indigo-500/30'
                                                                                                : 'bg-gray-400/20'
                                                                                            }`} />

                                                                                        {/* Inner Status Circle */}
                                                                                        <div className={`relative w-4 h-4 rounded-full transition-all duration-500 ${isPublic
                                                                                    ...
                                                                                    {/* Status Text */}
                                                                                    <div className="flex flex-col">
                                                                                        <span className={`text-base font-bold transition-all duration-300 ${isPublic
                            ...
                            `}>
                                                                                                ...
                                                                                                {loading ? (
                                                                                                    ...
                                                                                                    <>
                                                                                                        {/* Lock/Unlock Icon */}
                                                                                                        <svg
                                                                                                            className={`w-3 h-3 transition-all duration-300 ${isPublic
                                                                                                                    ? 'text-indigo-600'
