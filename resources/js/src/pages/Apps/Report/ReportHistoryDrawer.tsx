...
const handleShareToTelegram = async () => {
    ...
    const safeFileName = `${cleanName.toString().toUpperCase()}-QR.png`
                    ...
                    >
                        <Dialog.Panel className="pointer-events-auto w-screen max-w-6xl">
                            ...
                            <div className="flex h-screen gap-0">
                                ...
                                <div className="flex-1 flex flex-col bg-white dark:bg-[#0e1726] border-r border-gray-200 dark:border-gray-700">
        ...
        <div className="py-10 text-center bg-gray-50/50 dark:bg-gray-800/30 rounded-3xl border-2 border-dashed border-gray-100 dark:border-gray-800">
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
                No recorded yet
                                ...
                                <div className="flex-1 flex flex-col bg-white dark:bg-[#0e1726] ">
                                    {/* Header */}
                                    <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700/50 bg-gradient-to-r from-primary/5 to-transparent">
                                                                ...
                                                                <div className="text-xs text-gray-500 dark:text-gray-400">
                                                                    <span className="inline-flex items-center gap-1">
                                                                        ...
                                                                        <span className="font-semibold text-gray-700 dark:text-gray-300">
                                                                            {(report.report_data?.kpi?.views || report.report_data?.total_views || 0).toLocaleString()}
                                                                        </span>
                                                                    </span>
                                                                </div>
                                                            </div>
