        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className={`transition-all ${isFilterPanelVisible
    ...
    <TabsList className="grid w-full grid-cols-2 h-10 border bg-background">
                ...
                {(canFacebook && canTiktok) && (
                  <div className="space-y-2">
                    ...
                    <Tabs
                      ...
                      onValueChange={(value) => { setFilterPlatform(value); setPageIndex(0); }}
                    >
                              ...
                              return (
                                <div
                                  ...
                                  onClick={() => {
                                    ...
                                    handleUserFilterChange(newSelection);
                                  }}
                                >
                                  <Checkbox
                                    checked={isSelected}
                ...
                <div className="space-y-2">
                  ...
                  <Listbox value={filterStatus} onChange={(value) => { setFilterStatus(value); setPageIndex(0); }}>
                    <div className="relative">
                      <Listbox.Button className="relative w-full cursor-pointer rounded-md border border-input bg-background h-10 pl-3 pr-10 text-left text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
                      ...
                      <Transition
                        ...
                        leaveTo="opacity-0"
                      >
                        <Listbox.Options className="absolute z-50 mt-1 w-full rounded-md bg-popover py-1 shadow-lg border border-border focus:outline-none max-h-64 overflow-auto">
                          {filterOptions.map((option, idx) => (
                            <Listbox.Option
                              key={idx}
                              className={({ active }) =>
                                `relative cursor-pointer py-2 pl-9 pr-4 text-sm ${active ? 'bg-accent text-accent-foreground' : 'text-popover-foreground'
                                }`
                              }
                              value={option.value}
                            >
      ...
      {loading ? (
        ...
        <>
              ...
              {paginatedPages.map((page, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`relative h-32 ${page.platform === 'facebook'
                        ...
                        <div className="flex gap-2">
                          <Tippy content={isActive ? tButton('deactivate') : tButton('activate')}
                            ...
                            <button
                              ...
                              className={`p-2 rounded-xl backdrop-blur-md transition-all duration-300 ${isActive
                          ...
                          <Tippy content={isFav ?
                            ...
                            <button
                              ...
                              className={`p-2 rounded-xl backdrop-blur-md transition-all duration-300 ${isFav
                    ...
                    <div className="p-5 pt-14 relative">
                      ...
                      <div className="absolute -top-12 left-1/2 -translate-x-1/2">
                        <div className="relative">
                          ...
                          <div
                            className={`absolute -bottom-1 -right-1 w-6 h-6 border-4 border-white dark:border-[#1b2e4b] rounded-full shadow-lg ${page.is_active ? 'bg-green-500' : 'bg-red-500'
                              }`}
          ...
          {/* --- VIEW MODE: LIST --- */}
          {viewMode === 'list' && (
            <div className="panel p-0 overflow-hidden border">
                        ...
                        <td className="p-4 text-center">
                          <div className="flex justify-center gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            <Tippy content={tButton('edit')} theme='secondary'
                              ...
                              hideOnClick={true} >
                              <button
                                className="btn btn-sm btn-outline shadow-none w-8 h-8 rounded-full p-0 flex items-center justify-center"
