    ...
    const fetchDashboard = async () => {
        try {
            ...
            if (e.response?.status === 403) {
                // If the user is banned, the interceptor should handle it, 
                // but safety check here helps avoids crash
            }
        } finally {
            setLoading(false);
        }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="panel bg-gradient-to-r from-blue-500 to-blue-400 text-white">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold">{data?.stats?.my_reports || 0}</div>
                    </div>
                </div>
                ...
                <div className="panel bg-gradient-to-r from-violet-500 to-violet-400 text-white">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold">{data?.stats?.token_left || 0}</div>
                    </div>
                </div>
            </div>
