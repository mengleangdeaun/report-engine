...
const SubscriptionManager = () => {
    ...
    const getExpiryPreview = (monthsToAdd: number) => {
        ...
        return formatUserDate(newExpiry);
    };
                                    ...
                                    <tr key={team.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-gray-500 dark:text-gray-400">
                                                        Created {formatUserDate(team.created_at)}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`font-medium capitalize ${team.plan_type === 'pro' ? 'text-purple-600 dark:text-purple-400' :
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                                {availablePlans.map((plan) => (
                                                    <button
                                                        ...
                                                        className={`p-3 rounded-lg border-2 transition-all ${selectedPlan === plan.slug
                                            ...
                                            <div className="grid grid-cols-5 gap-2">
                                                {DURATIONS.map((dur) => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-2 text-sm rounded-lg border transition-all ${duration === dur.months
                                                                ? 'border-primary bg-primary/5 text-primary'
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center justify-between mb-4 p-3 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                                                ...
                                                <div className="w-24 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                                    <div
                                                        className={`h-full transition-all duration-500 ${(selectedTeam?.members_count / selectedTeam?.member_limit) >= 1 ? 'bg-red-500' : 'bg-primary'
                                                            }`}
