...
import {
    ...
    IconChartBar, IconTicket, IconKey, IconCrown, IconPhoto, IconDatabase
...
const PlanSettings = () => {
    ...
    const defaultPlan = {
        ...
        storage_limit_mb: 512, // Default 512MB
    };
                ...
                {plans.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {plans.map((plan) => (
                            <div
                                key={plan.id}
                                className={`relative bg-white dark:bg-gray-800 rounded-xl border-2 transition-all duration-200 hover:shadow-lg hover:-translate-y-1 ${!plan.is_active
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="space-y-4 mb-6">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1">
                                                <p className="text-xs text-gray-500 dark:text-gray-400">Storage Limit</p>
                                                <p className="font-semibold text-gray-900 dark:text-white">
                                                    {plan.storage_limit_mb === 0 ? 'Unlimited' : `${plan.storage_limit_mb} MB`}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="border-b border-gray-200 dark:border-gray-700 px-6">
                                        <nav className="flex space-x-6" aria-label="Tabs">
                                            <button
                                                ...
                                                className={`py-3 px-1 font-medium text-sm border-b-2 transition-colors ${activeTab === 'details'
                                            ...
                                            <button
                                                ...
                                                className={`py-3 px-1 font-medium text-sm border-b-2 transition-colors ${activeTab === 'features'
                                                    ? 'border-primary text-primary'
                                                    : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                                                    }`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`py-3 px-1 font-medium text-sm border-b-2 transition-colors ${activeTab === 'appearance'
                                                    ? 'border-primary text-primary'
                                                    : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
                                                    }`}
                                            >
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    type="text"
                                                                    className={`w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all ${currentPlan.id ? 'bg-gray-100 dark:bg-gray-700 cursor-not-allowed' : ''
                                                                        }`}
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                >
                                                                    {({ open }) => (
                                                                        <div className="relative">
                                                                            <Listbox.Button className="relative w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-left focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all cursor-pointer disabled:opacity-60">
                                                                                <span className={`flex items-center gap-2 text-sm font-medium ${currentPlan.is_active
                                                                                    ? 'text-emerald-600 dark:text-emerald-400'
                                                                                    : 'text-gray-500 dark:text-gray-400'
                                                                                    }`}>
                                                                                    <span className={`inline-block w-2 h-2 rounded-full ${currentPlan.is_active ? 'bg-emerald-500' : 'bg-gray-400'
                                                                                        }`} />
                                                                                    {currentPlan.is_active ? 'Active' : 'Inactive'}
                                                                                </span>
                                                                                <span className="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                                                                                    <IconChevronDown size={16} className={`text-gray-400 transition-transform duration-200 ${open ? 'rotate-180' : ''}`} />
                                                                                </span>
                                                                            </Listbox.Button>
                                                                            <Transition
                                                                                as={Fragment}
                                                                            ...
                                                                            >
                                                                                <Listbox.Options className="absolute z-50 mt-1 w-full overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-2xl focus:outline-none">
                                                                                    {[
                                                                                        { value: '1', label: 'Active', color: 'text-emerald-600 dark:text-emerald-400', dot: 'bg-emerald-500' },
                                                                                        { value: '0', label: 'Inactive', color: 'text-gray-500 dark:text-gray-400', dot: 'bg-gray-400' },
                                                                                    ].map((opt) => (
                                                                                        <Listbox.Option
                                                                                            key={opt.value}
                                                                                            value={opt.value}
                                                                                            className={({ active }) =>
                                                                                                `relative flex items-center gap-3 px-4 py-3 cursor-pointer select-none transition-colors ${active ? 'bg-primary/5 dark:bg-primary/10' : ''
                                                                                                }`
                                                                                            }
                                                                                        >
                                                                                            {({ selected }) => (
                                                                                                <>
                                                                                                    ...
                                                                                                    <span className={`flex-1 text-sm font-medium ${opt.color}`}>{opt.label}</span>
                                                                                                    {selected && <IconCheck size={14} className="text-primary shrink-0" />}
                                                                                                </>
                                                                                            )}
                                                                                        </Listbox.Option>
                                                                                    ))}
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input
                                                                    type="number"
                                                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                                                                    value={currentPlan.storage_limit_mb}
                                                                    onChange={(e) => handleChange('storage_limit_mb', parseInt(e.target.value) || 0)}
                                                                    min="0"
                                                                    step="128"
                                                                    disabled={isSubmitting}
                                                                />
                                                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                                                    Media library storage quota. 0 = Unlimited.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div key={moduleName} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                                                                    ...
                                                                    <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-2">
                                                                        {features.map((feature: any) => (
                                                                            <label
                                                                                key={feature.id}
                                                                                className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition-all ${currentPlan.features?.includes(feature.name)
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                                                            Choose the accent color applied to this plan's card and visual indicators
                                                        </p>
                                                    </div>
                                                            ...
                                                            {availableColors.map((color) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className={`relative group aspect-square rounded-lg flex items-center justify-center transition-all transform hover:scale-105 ${isSelected
                                                                ...
                                                                <div className="relative flex items-start gap-4">
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        ...
                                                                        <div className="mt-4 grid grid-cols-2 gap-3">
                                                                            ...
                                                                            <div className="flex items-center gap-2">
                                                                                <IconDatabase size={14} className="text-gray-400" />
                                                                                <span className="text-sm text-gray-600 dark:text-gray-400">
                                                                                    {currentPlan.storage_limit_mb === 0 ? 'Unlimited' : `${currentPlan.storage_limit_mb} MB`} Storage
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
