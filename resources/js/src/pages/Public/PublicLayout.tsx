            ...
            <header className="bg-white/70 dark:bg-[#0e1726]/70 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800/50 py-3 md:py-4 sticky top-0 z-50 shadow-sm dark:shadow-gray-900/20">
                <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
                        <div className="w-16 h-6 sm:w-20 sm:h-7 md:w-24 md:h-8 bg-gradient-to-r from-blue-500 to-blue-700 rounded-md sm:rounded-lg md:rounded-xl flex items-center justify-center text-white font-bold text-[10px] sm:text-xs md:text-base">
                            REPORT
                        </div>
                        <span className="text-base sm:text-lg md:text-xl font-black uppercase dark:text-white">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="p-1.5 sm:p-2 rounded-lg md:rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-800 transition-all hover:scale-105 active:scale-95"
                            aria-label={isDarkMode ? "Switch to light mode" : "Switch to dark mode"}
                        >
                            {isDarkMode ?
                                <IconSun size={16} className="sm:w-5 sm:h-5 text-yellow-400" /> :
                                <IconMoon size={16} className="sm:w-5 sm:h-5 text-gray-600 dark:text-gray-400" />
                            }
                        </button>
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg md:rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-800 transition-all hover:scale-105 active:scale-95"
                            aria-label="Toggle language"
                        >
                            <IconLanguage size={14} className="sm:w-5 sm:h-5 text-gray-600 dark:text-gray-400" />
                            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-wider dark:text-white">
