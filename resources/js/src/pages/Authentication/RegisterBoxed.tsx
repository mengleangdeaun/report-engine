...
const RegisterBoxed = () => {
    ...
    // ✅ 2. Get URL Parameters (Token & Email)
    ...
    // ✅ 3. Pre-fill Email if present in URL
    ...
    const submitForm = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.post('/register', {
                ...
                token: inviteToken // <--- Pass the token here
            });
                ...
                <div className="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
                    <div className="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                        <div className="mx-auto w-full max-w-[440px]">
                            <div className="mb-10">
                                ...
                                <p className="text-base font-bold leading-normal text-white-dark">
                                    {inviteEmail ? 'Accept Invitation & Create Account' : 'Enter your details to register'}
                                </p>
                            </div>
                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input 
                                            ...
                                            // Conditional Styling
                                            className={`form-input ps-10 placeholder:text-white-dark ${inviteEmail ? 'bg-gray-100 dark:bg-gray-800 cursor-not-allowed opacity-70' : ''}`}
                                            value={email}
                                            onChange={(e) => setEmail(e.target.value)}
                                            readOnly={!!inviteEmail} // Lock it
                                        />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                ...
                                <div className="flex justify-center my-2">
                                    <Turnstile 
                                        ref={turnstileRef}
                                        siteKey="0x4AAAAAACGuJjGIubUWR5hI" 
                        ...
                        <div className="text-center dark:text-white">
                                    ...
                                    {/* ✅ FIX: Append the current search params (token & email) to the Login Link */}
                                    <Link 
                                        to={`/auth/boxed-signin${location.search}`} 
